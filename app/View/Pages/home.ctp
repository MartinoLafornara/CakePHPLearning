    ...
    <div class="container my-auto">
        <div class="row" style='padding-top:30%'>
            <div class="col-lg-10 mx-auto">
                <h1 class='title'>
                    <strong>PostITADESSO</strong>
                </h1>
                <hr>
            </div>
            <div class="col-lg-8 mx-auto ">
                <p class='description'>Blog Site</p>
                <?= $this->Html->link('About Us',array('action' => '#about'),array('class' => 'btn btn-primary btn-outline btn-circle js-scroll-trigger')) ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 mx-auto text-center">
        ...
        <?= $this->Html->link('Get Started!',array('action' => '#services'),array('class' => 'btn btn-light btn-xl  js-scroll-trigger')) ?>
      </div>
    </div>
  </div>
</section>
